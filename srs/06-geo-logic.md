...
### Strategy
1. **Reverse geocode via `tz_world` + `natural_earth` boundaries** (offline, fast)
2. **Fallback**: Mapbox Geocoding API (online, accurate but costs $)

### Data Sources
- Timezone boundary shapes: `tz_world_mp.zip`
- Natural Earth country shapes: `ne_10m_admin_0_countries.zip`
